...
def vllm_infer(
    ...
    r"""Performs batch generation using vLLM engine, which supports tensor parallelism.
    ...
    sampling_params = SamplingParams(
        ...
        repetition_penalty=1.2,  # repetition_penalty must > 0
        # temperature=generating_args.temperature,
        temperature=0.4,
        # top_p=generating_args.top_p or 0.9,  # top_p must > 0
        top_p=0.9,
        top_k=50,
