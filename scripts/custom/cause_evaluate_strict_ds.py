...
def clean_text(text):
    ...
    try:
        ...
        if json_start >= 0:
            ...
            if json_end >= 0:
                text = potential_json[:json_end + 1]
        ...
        print(f"Error in initial JSON extraction: {e}")
    ...
    try:
        ...
        if json_start >= 0 and json_end > json_start:
            ...
            try:
                ...
                print(f"Invalid JSON after cleaning: {text[:200]}...")

    except Exception as e:
        print(f"Error in fallback cleaning: {e}")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        jsonl_file_path = "saves/DeepSeek/DeepSeek-R1-Distill-Llama-8B-cause/qlora/predict/100/generated_predictions.jsonl"
